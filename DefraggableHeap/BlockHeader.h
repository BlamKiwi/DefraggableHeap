...
struct BlockHeader
{
	...
	*	Does not calculate statistics for the heap tree.
	*
	*	@param left the index for our left subtree
	*	@param right the index for our right subtree
	...
	*/
	...
	/**< Index of the left subtree for this header. */
	IndexType _left;

	/**< Index of the right subtree for this header. */
	IndexType _right;
	...
	/**< The local maximum number of contiguous free chunks in the heap tree. */
